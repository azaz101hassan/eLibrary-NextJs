...
const book = () => {
  ...
  const places =
    book.places === "N/A" ? (
      ...
      <>
        Mentions{" "}
        <span className="text-blue-500 dark:text-blue-400">{book.places}</span>
      </>
    );
            ...
            <div>
              ...
              <div className="flex flex-col justify-space-between items-center">
                <p className="mt-2 ml-2 text-sm font-medium text-gray-500 dark:text-gray-400">
                  Published in:{" "}
                  <span className="text-green-500">{book.date}</span>
                </p>
                <p className="mt-2 ml-2 text-sm font-medium text-gray-500 dark:text-gray-400">
                  {places}
                </p>
                <p className="mt-2 ml-2 text-sm font-medium text-yellow-500 dark:text-yellow-400">
                  {rating}
                </p>
              </div>
